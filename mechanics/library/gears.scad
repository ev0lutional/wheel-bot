...
/*  Bevel Gear Pair with any axis_angle; uses the Module "bevel_gear"
    ...
    helix_angle = Helix Angle, Standard = 0°
    together_built = Components assembled for Construction or separated for 3D-Printing */
module bevel_gear_pair(modul, gear_teeth, pinion_teeth, axis_angle=90, tooth_width, gear_bore, pinion_bore, pressure_angle=20, helix_angle=0, together_built=true, draw_gear = true, draw_pinion = true){
...
bevel_gear_pair(modul=1, gear_teeth=30, pinion_teeth=11, axis_angle=90, tooth_width=5, gear_bore=4, pinion_bore=4, pressure_angle = 25, helix_angle=20, together_built=true);
